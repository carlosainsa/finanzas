...
def load_execution_probe_v8_fraction_selection(
    path: str | None,
    *,
    default_fraction: float,
) -> ExecutionProbeFractionSelection:
...
def load_execution_probe_v9_fraction_selection(
    path: str | None,
    *,
    default_fraction: float,
) -> ExecutionProbeFractionSelection:
...
def load_execution_probe_v10_fraction_selection(
    path: str | None,
    *,
    default_fraction: float,
) -> ExecutionProbeFractionSelection:
...
def load_execution_probe_v12_fraction_selection(
    path: str | None,
    *,
    default_fraction: float,
) -> ExecutionProbeFractionSelection:
...
def validate_execution_probe_v8_fraction_selection(
    selection: ExecutionProbeFractionSelection,
) -> None:
    validate_execution_probe_fraction_selection(selection, profile="execution_probe_v8")


def validate_execution_probe_v9_fraction_selection(
    selection: ExecutionProbeFractionSelection,
) -> None:
    validate_execution_probe_fraction_selection(selection, profile="execution_probe_v9")


def validate_execution_probe_v10_fraction_selection(
    selection: ExecutionProbeFractionSelection,
) -> None:
...
def validate_execution_probe_v12_fraction_selection(
    selection: ExecutionProbeFractionSelection,
) -> None:
    validate_execution_probe_fraction_selection(selection, profile="execution_probe_v12")
