...
export async function loadDashboard(): Promise<DashboardData> {
  ...
  const [risk, streams, orders, positions, reports, markets, metrics, controlResults, reconciliation, runtime, nimBudget, goNoGo, preLiveReadiness, researchRuns] = await Promise.all([
...
export const fallbackData: DashboardData = {
  ...
  preLiveReadiness: {
    ...
    report_root: null,
    can_execute_trades: false,
    go_no_go: { decision: 'NO_GO', profile: null, passed: false },
    checks: [],
    blockers: [],
    audit: { status: 'not_checked', source: 'postgres' },
    artifacts: {},
  },
  researchRuns: [],
};
