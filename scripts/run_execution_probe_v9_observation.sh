...
export SIGNAL_REJECTION_PROFILES="${SIGNAL_REJECTION_PROFILES:-execution_probe_v9}"
export SIGNAL_REJECTION_BASELINE_PROFILE="${SIGNAL_REJECTION_BASELINE_PROFILE:-execution_probe_v9}"
export SIGNAL_REJECTION_CANDIDATE_PROFILE="${SIGNAL_REJECTION_CANDIDATE_PROFILE:-execution_probe_v9}"
