...
async def main() -> None:
    ...
    evidence = {
        ...
        "predictor_execution_probe_min_signal_interval_ms": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_MIN_SIGNAL_INTERVAL_MS"
        ),
        "predictor_execution_probe_v2_min_confidence": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V2_MIN_CONFIDENCE"
        ),
        "predictor_execution_probe_v2_min_depth": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V2_MIN_DEPTH"
        ),
        "predictor_execution_probe_v2_max_top_changes": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V2_MAX_TOP_CHANGES"
        ),
        "predictor_execution_probe_v2_near_touch_max_spread_fraction": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V2_NEAR_TOUCH_MAX_SPREAD_FRACTION"
        ),
        "predictor_execution_probe_v2_min_signal_interval_ms": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V2_MIN_SIGNAL_INTERVAL_MS"
        ),
        "predictor_execution_probe_v3_min_confidence": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V3_MIN_CONFIDENCE"
        ),
        "predictor_execution_probe_v3_min_depth": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V3_MIN_DEPTH"
        ),
        "predictor_execution_probe_v3_max_top_changes": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V3_MAX_TOP_CHANGES"
        ),
        "predictor_execution_probe_v3_near_touch_max_spread_fraction": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V3_NEAR_TOUCH_MAX_SPREAD_FRACTION"
        ),
        "predictor_execution_probe_v3_min_signal_interval_ms": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V3_MIN_SIGNAL_INTERVAL_MS"
        ),
        "predictor_execution_probe_v4_min_confidence": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V4_MIN_CONFIDENCE"
        ),
        "predictor_execution_probe_v4_min_depth": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V4_MIN_DEPTH"
        ),
        "predictor_execution_probe_v4_max_top_changes": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V4_MAX_TOP_CHANGES"
        ),
        "predictor_execution_probe_v4_near_touch_max_spread_fraction": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V4_NEAR_TOUCH_MAX_SPREAD_FRACTION"
        ),
        "predictor_execution_probe_v4_min_signal_interval_ms": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V4_MIN_SIGNAL_INTERVAL_MS"
        ),
        "predictor_execution_probe_v5_min_confidence": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V5_MIN_CONFIDENCE"
        ),
        "predictor_execution_probe_v5_min_depth": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V5_MIN_DEPTH"
        ),
        "predictor_execution_probe_v5_max_top_changes": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V5_MAX_TOP_CHANGES"
        ),
        "predictor_execution_probe_v5_near_touch_max_spread_fraction": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V5_NEAR_TOUCH_MAX_SPREAD_FRACTION"
        ),
        "predictor_execution_probe_v5_min_signal_interval_ms": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V5_MIN_SIGNAL_INTERVAL_MS"
        ),
        "predictor_execution_probe_v5_fraction_selection_path": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V5_FRACTION_SELECTION_PATH"
        ),
        "predictor_execution_probe_v6_min_confidence": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V6_MIN_CONFIDENCE"
        ),
        "predictor_execution_probe_v6_min_depth": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V6_MIN_DEPTH"
        ),
        "predictor_execution_probe_v6_max_top_changes": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V6_MAX_TOP_CHANGES"
        ),
        "predictor_execution_probe_v6_near_touch_max_spread_fraction": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V6_NEAR_TOUCH_MAX_SPREAD_FRACTION"
        ),
        "predictor_execution_probe_v6_min_signal_interval_ms": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V6_MIN_SIGNAL_INTERVAL_MS"
        ),
        "predictor_execution_probe_v6_offset_ticks": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V6_OFFSET_TICKS"
        ),
        "predictor_execution_probe_v6_fraction_selection_path": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V6_FRACTION_SELECTION_PATH"
        ),
        "predictor_execution_probe_v7_min_confidence": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V7_MIN_CONFIDENCE"
        ),
        "predictor_execution_probe_v7_min_depth": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V7_MIN_DEPTH"
        ),
        "predictor_execution_probe_v7_max_top_changes": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V7_MAX_TOP_CHANGES"
        ),
        "predictor_execution_probe_v7_near_touch_max_spread_fraction": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V7_NEAR_TOUCH_MAX_SPREAD_FRACTION"
        ),
        "predictor_execution_probe_v7_min_signal_interval_ms": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V7_MIN_SIGNAL_INTERVAL_MS"
        ),
        "predictor_execution_probe_v7_offset_ticks": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V7_OFFSET_TICKS"
        ),
        "predictor_execution_probe_v7_fraction_selection_path": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V7_FRACTION_SELECTION_PATH"
        ),
        "predictor_execution_probe_v8_min_confidence": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V8_MIN_CONFIDENCE"
        ),
        "predictor_execution_probe_v8_min_depth": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V8_MIN_DEPTH"
        ),
        "predictor_execution_probe_v8_max_top_changes": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V8_MAX_TOP_CHANGES"
        ),
        "predictor_execution_probe_v8_near_touch_max_spread_fraction": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V8_NEAR_TOUCH_MAX_SPREAD_FRACTION"
        ),
        "predictor_execution_probe_v8_min_signal_interval_ms": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V8_MIN_SIGNAL_INTERVAL_MS"
        ),
        "predictor_execution_probe_v8_offset_ticks": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V8_OFFSET_TICKS"
        ),
        "predictor_execution_probe_v8_fraction_selection_path": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V8_FRACTION_SELECTION_PATH"
        ),
        "predictor_execution_probe_v9_min_confidence": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V9_MIN_CONFIDENCE"
        ),
        "predictor_execution_probe_v9_min_depth": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V9_MIN_DEPTH"
        ),
        "predictor_execution_probe_v9_max_top_changes": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V9_MAX_TOP_CHANGES"
        ),
        "predictor_execution_probe_v9_near_touch_max_spread_fraction": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V9_NEAR_TOUCH_MAX_SPREAD_FRACTION"
        ),
        "predictor_execution_probe_v9_min_signal_interval_ms": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V9_MIN_SIGNAL_INTERVAL_MS"
        ),
        "predictor_execution_probe_v9_offset_ticks": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V9_OFFSET_TICKS"
        ),
        "predictor_execution_probe_v9_fraction_selection_path": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V9_FRACTION_SELECTION_PATH"
        ),
        "predictor_execution_probe_v10_min_confidence": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V10_MIN_CONFIDENCE"
        ),
        "predictor_execution_probe_v10_min_depth": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V10_MIN_DEPTH"
        ),
        "predictor_execution_probe_v10_max_top_changes": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V10_MAX_TOP_CHANGES"
        ),
        "predictor_execution_probe_v10_near_touch_max_spread_fraction": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V10_NEAR_TOUCH_MAX_SPREAD_FRACTION"
        ),
        "predictor_execution_probe_v10_min_signal_interval_ms": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V10_MIN_SIGNAL_INTERVAL_MS"
        ),
        "predictor_execution_probe_v10_offset_ticks": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V10_OFFSET_TICKS"
        ),
        "predictor_execution_probe_v10_fraction_selection_path": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V10_FRACTION_SELECTION_PATH"
        ),
        "predictor_execution_probe_v11_min_confidence": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V11_MIN_CONFIDENCE"
        ),
        "predictor_execution_probe_v11_min_depth": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V11_MIN_DEPTH"
        ),
        "predictor_execution_probe_v11_max_top_changes": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V11_MAX_TOP_CHANGES"
        ),
        "predictor_execution_probe_v11_near_touch_max_spread_fraction": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V11_NEAR_TOUCH_MAX_SPREAD_FRACTION"
        ),
        "predictor_execution_probe_v11_min_signal_interval_ms": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V11_MIN_SIGNAL_INTERVAL_MS"
        ),
        "predictor_execution_probe_v11_offset_ticks": os.environ.get(
            "PREDICTOR_EXECUTION_PROBE_V11_OFFSET_TICKS"
        ),
