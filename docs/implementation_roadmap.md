...
10. Live promotion gates
   ...
   - Next execution step: collect or select a fresher runtime-active universe before another observation. Do not enable live until the comparison shows observed fills, low synthetic optimism, and acceptable adverse selection.
